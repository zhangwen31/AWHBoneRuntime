#
#  Be sure to run `pod spec lint AWHBoneRuntime.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBoneRuntime.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/WHWorkDevelopment/AWHBoneRuntime-iOS"
  ...
  s.social_media_url   = "https://github.com/WHWorkDevelopment/AWHBoneRuntime-iOS.git"
  ...
  s.source       = { :git => "https://github.com/WHWorkDevelopment/AWHBoneRuntime-iOS.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHBoneRuntime/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHBoneRuntime/**/*.h"

  s.vendored_frameworks = ['AWHBoneRuntime.framework']

  s.pod_target_xcconfig = {'VALID_ARCHS' => 'x86_64 armv7 arm64'}

  s.source_files = 'AWHBoneRuntime.framework/Headers/*h'
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHBoneRuntimeLocalizable.bundle']
